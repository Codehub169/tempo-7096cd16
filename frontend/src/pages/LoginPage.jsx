...
import { GiHeartWings } from 'react-icons/gi'; // Example for logo
...
const AnimatedShape = ({ color, left, animationDelay, animationDuration, size, isSquare }) => {
  const style = {
    ...
    opacity: 0.5, // Adjusted from HTML for better visibility with Chakra theme
      ...
      <Center w="full" maxW="420px" p={5} zIndex="1">
        ...
        >
          <VStack spacing={3} mb={4}>
            <Icon as={GiHeartWings} w={20} h={20} color="primary.500" animation="bounce 1.5s infinite" />
          ...
          <FormControl id="username">
            <InputGroup>
              <InputLeftElement pointerEvents="none">
                <Icon as={FaUserAstronaut} color="primary.400" />
              </InputLeftElement>
          ...
          <FormControl id="password">
            <InputGroup>
              <InputLeftElement pointerEvents="none">
                <Icon as={FaKey} color="primary.400" />
              </InputLeftElement>
          ...
          <VStack spacing={2} fontSize="sm">
            <Text>
              New here?{' '}
              <Link as={RouterLink} to="/signup" color="accent.500" fontWeight="medium" _hover={{ color: 'primary.500', textDecoration: 'underline' }}>
                Join the club!
              </Link>
            </Text>
            <Link href="#" color="textColor" _hover={{ color: 'primary.500' }}>
              Forgot your handshake?
            </Link>
            <Link as={RouterLink} to="/" color="textColor" _hover={{ color: 'primary.500' }} mt={4}>
